...
Route::get('/kota/{id}', [ProvinsiController::class,'kota']);
Route::get('/kecamatan/{id}', [ProvinsiController::class,'kecamatan']);
Route::get('/desa/{id}', [ProvinsiController::class,'desa']);
Route::get('/rw/{id}', [ProvinsiController::class,'rw']);
